...
//reading GPIO value
    gpio_state = gpio_get_value(GPIO_21); //7-g
    gpio_state = gpio_get_value(GPIO_20); //7-f
    gpio_state = gpio_get_value(GPIO_16); //7-a
    gpio_state = gpio_get_value(GPIO_12); //7-b
    gpio_state = gpio_get_value(GPIO_18); //7-e
    gpio_state = gpio_get_value(GPIO_15); //7-d
    gpio_state = gpio_get_value(GPIO_14); //7-c
